...
public class User {
    ...
    public synchronized void setSentCounter(int value) {
        sentCounter.setValue(String.valueOf(value));
    }
    public synchronized void setInboxCounter(int value) {
        inboxCounter.setValue(String.valueOf(value));
    }
    public synchronized void setTrashedCounter(int value) {
    ...
    public synchronized void deleteInbox(Email email) {
        inbox.remove((email));
    }

    public synchronized void deleteSent(Email email) {
        sent.remove((email));
    }

    public synchronized void deleteTrashed(Email email) {
    ...
    public synchronized boolean checkDuplicates(ListProperty<Email> list, Email e) {
